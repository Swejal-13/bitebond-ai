/**
 * GoogleAuthButton — reusable Google OAuth button
 */
...
const GoogleAuthButton = ({ label = 'Continue with Google', disabled = false }) => {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700
        bg-white dark:bg-surface-dark-muted text-gray-700 dark:text-gray-300 font-semibold text-sm
